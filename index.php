...
<div class="Menue" align="center" margin-top="10px">
  ...
  header('Location: '. $_SERVER['PHP_SELF']);
     ...
     <table class="table-striped table" cellspacing="10">
        ...
        $row = mysqli_fetch_row($result)) hiermit wir die nächste Zeile des Ergebnisses eingelesen und dann in der Tabelle ausgegeben. Angewiesen Zeilenweise das Ergebnis zu lesen. 
